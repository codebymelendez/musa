/**
 * promotions.ts
 * Helpers puros para aplicar promociones al precio.
 * Promotion.discount es SIEMPRE un porcentaje (1–100) — ver zod en
 * /api/promotions y la UI de /promotions ("% Descuento").
