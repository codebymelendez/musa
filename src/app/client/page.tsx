...
export default function ClientPortalPage() {
  ...
  if (!token) {
    const savedName = typeof window !== "undefined"
      ? localStorage.getItem("musa_client_name")
      : null;
        ...
        <main className="px-6 pt-12 pb-16 max-w-sm mx-auto space-y-8 text-center">
          <div className="space-y-3">
            ...
            <h2 className="font-headline text-2xl font-extrabold tracking-tighter text-on-surface">
              {savedName ? `¡Hola, ${savedName}!` : "Tu espacio de belleza"}
            </h2>
  ...
  return (
    <div className="min-h-screen bg-background font-body antialiased pb-24">
      {/* Header */}
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-lg px-6 py-4 flex items-center justify-between shadow-sm shadow-purple-500/5">
        ...
        <button
          ...
          className="text-xs text-on-surface-variant hover:text-red-500 transition-colors font-medium"
        >
          Salir
        </button>
      </header>
                  ...
                  <div className="flex gap-2">
                    ...
                    {appt.user.whatsapp && appt.status !== "cancelled" && (
                      <a
                        ...
                        className="w-10 h-10 bg-[#25D366]/10 text-[#25D366] rounded-xl flex items-center justify-center hover:bg-[#25D366]/20 transition-colors"
                      >
