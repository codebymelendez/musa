          ...
          <section className="py-16 px-4" style={{ background: "#FAF9F7" }}>
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="flex items-center justify-center gap-4 flex-wrap">
                <div
                  className="flex items-center gap-3 px-5 py-3 rounded-xl border bg-surface-raised text-left"
                  style={{ borderColor: "#34271E" }}
                >
                  <DevicePhoneMobileIcon className="w-6 h-6 flex-shrink-0 text-[#34271E]" />
                  <div>
                    <p className="font-ui text-[10px] text-on-surface-muted leading-none mb-1">Próximamente</p>
                    <p className="font-ui font-medium text-[15px] text-[#34271E] leading-none">App Store</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    <p className="font-ui text-[10px] text-on-surface-muted leading-none mb-1">Próximamente</p>
                    <p className="font-ui font-medium text-[15px] text-[#34271E] leading-none">Google Play</p>
                  </div>
                </div>
              </div>
