  ...
  return (
    <div className="bg-surface-container-lowest rounded-2xl p-5 shadow-sm border border-outline-variant/10 space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        {canRedeem && (
          <span className="flex-shrink-0 text-[10px] font-medium bg-green-100 text-green-700 px-2.5 py-1 rounded-full">
            ¡Recompensa lista!
          </span>
        )}
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-end justify-between">
          <span className="text-2xl font-headline font-medium font-mono-num text-on-surface">
            {account.totalPoints}
          </span>
      ...
      <div className="flex gap-2">
        <Link
          ...
          className="flex-1 h-9 bg-surface-container text-on-surface-variant text-xs font-medium rounded-xl flex items-center justify-center gap-1 hover:bg-surface-container-high transition-colors text-on-surface-variant"
        >
        ...
        {canRedeem && onRedeem && (
          <button
            ...
            className="flex-1 h-9 bg-green-500 text-white text-xs font-medium rounded-xl flex items-center justify-center gap-1 hover:bg-green-600 transition-colors"
          >
